...
export default function BirthdayVideo() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-amber-50 dark:from-pink-950 dark:via-rose-950 dark:to-amber-950 py-20 px-6 relative overflow-hidden">
      <FloatingParticles />
      ...
      <div className={`max-w-6xl mx-auto relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl md:text-7xl text-handwritten text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-rose-500 to-amber-500 dark:from-pink-400 dark:via-rose-400 dark:to-amber-400 mb-4">
            Your Birthday Video 🎂💛
          </h1>
